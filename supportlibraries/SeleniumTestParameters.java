...
public class SeleniumTestParameters extends TestParameters
{
	...
	public TestEnvironment setTestEnvironment()
	{
		return environment;
	}
	/**
	 * Function to set the environment for a specific test
	 */
	public void setTestEnvironment(TestEnvironment environment)
	{
